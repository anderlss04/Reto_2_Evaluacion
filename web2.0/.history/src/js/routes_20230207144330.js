...
getHTML('../src/html/login.html', function (response) {
    login.template = response;
});

getHTML('../src/html/registro.html', function (response) {
    registro.template = response;
});

getHTML('../src/html/operar.html', function (response) {
    operar.template = response;
});

getHTML('../src/html/grafico.html', function (response) {
